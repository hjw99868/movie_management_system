...
function showConfirmModal(title, message, one_button, callback) {
    ...
    var no_button = '<button id="modal-no-button" class="btn btn-danger" data-dismiss="modal">Cancle</button>'
    var yes_button = '<button id="modal-yes-button" class="btn btn-success" data-dismiss="modal">Yes</button>'
