...
class OfficialAccount(models.Model):
    wx_id = models.CharField(u'公众号微信ID', max_length=100, unique=True)
    ...
    pic = models.CharField(null=True, blank=True, max_length=150)
...
class Application(models.Model):
    ...
    approve_reason = models.CharField(max_length=140, blank=True)
    def clean(self):
    ...
    def status_display(self):
        names = {
            ...
            'pending': 'Applications on Dealing',
